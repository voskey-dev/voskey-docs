...
- 返信・引用・リノート等に関わらず、ノートの公開範囲を判断基準とします。
    - 例：連合先ノートの公開範囲パブリックのホームへのリノートは、リノート者の投稿範囲ホームへのノートとして扱います。
...
- **R-18・R-18G要素のある画像が含まれるノートは、隔離の如何に関わらずセンシティブ指定されていないチャンネルでの投稿・RN・引用等を禁止します。**

## パブリック投稿

- **隔離に該当しません。** 別途隔離措置を行ってください。
- **R-18・R-18G要素のある画像が含まれるノートは、隔離の如何に関わらずパブリックでの投稿・RN・引用等を禁止します。**
...
- 連合先のノートの内容に関わらず、ぼすきー内でリノート・引用されたノートはぼすきーのモデレーションポリシーに従い、内容は**リノート・引用者の責任**となります。
    ...
    - **しっかり隔離されていれば**リモートのセンシティブノートを引用してもOKです。
        - ただし、R-18・R-18G要素のある画像が含まれるノートは、**公開範囲パブリック・センシティブ指定されていないチャンネルにRN・引用しないで下さい。**
